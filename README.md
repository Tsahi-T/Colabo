...
מעבד תמלילים שיתופי בזמן אמת לסביבות סגורות — פותחים מסמך, משתפים קישור, עובדים יחד.

**יכולות**: עריכה משותפת חיה (CRDT), סמנים צבעוניים של משתתפים, עיצוב טקסט מלא (צבע, מרקר, כותרות, רשימות), טבלאות, תמונות, RTL מלא, קישורי עריכה/צפייה נפרדים, ייצוא ל-Word/PDF/HTML, שמירה אוטומטית. ללא תלות באינטרנט בזמן ריצה.
